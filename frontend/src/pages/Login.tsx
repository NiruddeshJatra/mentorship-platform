        ...
        <CardContent className="pt-6">
          <form onSubmit={handleSubmit}>
            <div className="grid gap-4">
              ...
              <a href={`${process.env.NODE_ENV === 'production' ? 'https://mentorship-platform-tscc.onrender.com' : 'http://localhost:3000'}/api/auth/google`} className="w-full inline-flex items-center justify-center bg-white hover:bg-gray-100 border border-gray-300 text-gray-700 rounded-lg px-4 py-2">
